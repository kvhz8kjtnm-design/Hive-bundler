...
export const wallet = Keypair.fromSecretKey(bs58.decode(requireEnv("SIGNER_PRIVATE_KEY")));
export const payer  = Keypair.fromSecretKey(bs58.decode(requireEnv("FUNDER_PRIVATE_KEY")));
export const rpc    = requireEnv("RPC_URL");
